...
#define LIVE_VIDEO_DEF_WIDTH 720
#define LIVE_VIDEO_DEF_HEIGHT 1280
#define LIVE_VIDEO_DEF_FRAMERATE 25
#define LIVE_VIDEO_DEF_BITRATE   500000

#define LIVE_VIEDO_SIZE_CIF  (CGSizeMake(640,360)
#define LIVE_VIEDO_SIZE_D1   (CGSizeMake(960,540))
